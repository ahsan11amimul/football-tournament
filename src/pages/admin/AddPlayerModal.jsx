...
import { X, UserPlus, Shirt } from 'lucide-react';
...
export default function AddPlayerModal({ isOpen, onClose }) {
  ...
  const handlePlayerSelect = (e) => {
    ...
    if (selectedName) {
      setValue('fullName', selectedName);
    }
  };
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-2xl font-black italic uppercase tracking-tight" style={{ color: 'var(--text-color)' }}>Add Order</h2>
